...
import ro.democaip.config.Constants;
import ro.democaip.DemocaipApp;
import ro.democaip.domain.Authority;
import ro.democaip.domain.User;
import ro.democaip.repository.AuthorityRepository;
import ro.democaip.repository.UserRepository;
import ro.democaip.security.AuthoritiesConstants;
import ro.democaip.service.MailService;
import ro.democaip.service.dto.UserDTO;
import ro.democaip.web.rest.errors.ExceptionTranslator;
import ro.democaip.web.rest.vm.KeyAndPasswordVM;
import ro.democaip.web.rest.vm.ManagedUserVM;
