...
import ro.democaip.config.audit.AuditEventConverter;
import ro.democaip.domain.PersistentAuditEvent;
...
import static ro.democaip.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
